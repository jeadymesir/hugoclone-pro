...
const sections = [
  {
    ...
    detail: "RPBG's Next-Generation Networking Services deliver a perfectly engineered infrastructure that is fast, robust, and inherently secure. We handle everything, from intelligent Wi-Fi and SD-WAN optimization to 24/7 proactive monitoring.",
  },
  {
    id: 'voip',
    icon: Phone,
  ...
  },
  {
    ...
    items: ['Backup solutions', 'Business continuity', 'Recovery planning', 'Regular testing'],
    description: "In today's fast-paced digital landscape, business interruption isn't a possibility—it's an inevitability.",
    detail: "RPBG's Disaster Recovery and Business Continuity services are your definitive safety net. We engineer resilience, ensuring that when the unexpected strikes, your critical operations are restored rapidly.",
  },
  {
    id: 'security',
    icon: Shield,
    title: 'SECURITY SOLUTIONS',
    items: ['24/7/365 Monitoring', 'Security as a Service', 'End-point protection', 'Organization-wide cybersecurity'],
    description: "Information is one of the most important assets in today's organizations.",
